...
var out12b = new Date("2017/08/04 22:00");
var out12 = new Date("2017/08/04 23:00");
...
var tt_13 = new Date("2017/08/01 20:55");
var out13 = new Date("2017/08/01 22:00");
...
var tt_14 = new Date("2017/08/02 12:00");
var out14 = new Date("2017/08/02 12:35");
if (now.getTime() > tt_14.getTime()){
	ele14.innerText = '今すぐ視聴する';
} if (now.getTime() > out14.getTime()) {
	ele14.innerText = 'ビデオを視聴する';
	ele14.href = "https://abema.tv/video/title/134-24";
}
var tt_15 = new Date("2017/08/03 21:00");
var out15 = new Date("2017/08/03 22:00");
...
var tt_17 = new Date("2017/08/04 19:05");
var out17 = new Date("2017/08/04 20:57");
...
var tt_18 = new Date("2017/08/04 12:00");
var out18 = new Date("2017/08/04 12:53");
...
var tt_19 = new Date("2017/08/04 13:00");
var out19 = new Date("2017/08/04 14:58");
...
var tt_20 = new Date("2017/08/05 13:50");
var out20 = new Date("2017/08/05 14:57");
...
var tt_21 = new Date("2017/08/05 19:30");
var out21 = new Date("2017/08/05 20:30");
if (now.getTime() > tt_21.getTime()){
	ele21.innerText = '今すぐ視聴する';
}
var tt_22 = new Date("2017/08/06 23:30");
var out22 = new Date("2017/08/07 00:30");
...
var tt_23 = new Date("2017/08/08 23:30");
var out23 = new Date("2017/08/09 00:30");
...
var tt_24 = new Date("2017/08/10 23:30");
var out24 = new Date("2017/08/10 23:57");
...
var tt_25 = new Date("2017/08/12 19:00");
var out25 = new Date("2017/08/12 20:43");
...
var tt_26 = new Date("2017/08/04 23:00");
var out26 = new Date("2017/08/05 00:00");
if (now.getTime() > tt_26.getTime()){
	ele26.innerText = '今すぐ視聴する';
} if (now.getTime() > out26.getTime()) {
	ele26.innerText = 'ビデオを視聴する';
	ele26.href = "https://abema.tv/video/title/90-1092";
}
