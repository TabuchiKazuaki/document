...
var tt_01 = new Date("2018/06/06 21:30");
var out01 = new Date("2018/06/06 22:55");
if (now.getTime() > tt_01.getTime()){
	ele01.innerText = '今すぐ視聴する';
} if (now.getTime() > out01.getTime()) {
	ele01.innerText = '放送終了しました';
	ele01.style.backgroundColor = "#bbb";
	ele01.href = "javascript:void(0)";
}
var ttb_02 = new Date("2018/06/07 17:30");
var out02 = new Date("2018/06/07 18:00");
...
var tt_03 = new Date("2018/06/09 00:00");
var out03 = new Date("2018/06/09 00:55");
...
var tt_04 = new Date("2018/06/09 19:30");
var out04 = new Date("2018/06/09 20:45");
...
var tt_05 = new Date("2018/06/09 21:30");
var out05 = new Date("2018/06/09 23:00");
...
var tt_06 = new Date("2918/08/02 21:00");
var out06 = new Date("2018/06/02 22:15");
...
var tt_07 = new Date("2018/06/08 23:30");
var out07 = new Date("2018/06/09 00:45");
...
var tt_08 = new Date("2018/06/06 12:00");
var out08 = new Date("2018/06/06 13:20");
...
var tt_09 = new Date("2018/06/08 03:45");
var out09 = new Date("2018/06/08 04:50");
...
var tt_10 = new Date("2018/06/08 09:55");
var out10 = new Date("2018/06/08 12:00");
