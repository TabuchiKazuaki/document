...
var tt06 = new Date("2018/07/05 22:59");
var outs6 = new Date("2018/07/13 00:50");
if (now.getTime() > tt06.getTime()){
	ele06.innerText = '今すぐ視聴する';
} if (now.getTime() > outs2.getTime()) {
	ele06.innerText = '放送終了しました';
	ele06.style.backgroundColor = "#bbb";
	ele06.href = "javascript:void(0)";
}
