...
$(document).ready(function() {
	...
	// $(d02).html(day02+2);
	// // 無料文言削除
	// var timeOut02 = new Date("2018/10/06 23:59");
	...
	// $(d09).html(day09+2);
	// // 無料文言削除
	// var timeOut09 = new Date("2018/10/06 23:59");
