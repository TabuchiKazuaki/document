...
$(document).ready(function() {
	...
	$(d03).html(day03+1);
	// 無料文言削除
	var timeOut03 = new Date("2018/10/08");
	...
	$(d04).html(day04+1);
	// 無料文言削除
	var timeOut04 = new Date("2018/10/11");
	...
	$(d05).html(day05+1);
	// 無料文言削除
	var timeOut05 = new Date("2018/10/10");
	...
	$(d08).html(day08+1);
	// 無料文言削除
	var timeOut08 = new Date("2018/10/12");
	...
	$(d09).html(day09+1);
	// 無料文言削除
	var timeOut09 = new Date("2018/10/18");
	...
	$(d10).html(day10+1);
	// 無料文言削除
	var timeOut10 = new Date("2018/10/11");
