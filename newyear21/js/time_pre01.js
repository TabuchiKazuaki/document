...
function countDown() {
	...
	var time01 = new Date("2020/12/26 21:00");
	if (now.getTime() > time01.getTime()) {
		$(".t01").text("さっそくみる");
		$(".t01").attr("href","abema");
	}
	var time01_af = new Date("2021/01/02 23:00");
	if (now.getTime() > time01_af.getTime()) {
		$(".t01").text("さっそくみる");
		$(".t01").attr("href","abema");
	}

	var time02 = new Date("2020/12/26 21:00");
	...
	var time03 = new Date("2020/12/29 22:00");
	...
	var time04 = new Date("2020/12/31 18:00");
	...
	var time05 = new Date("2020/12/29 20:00");
	if (now.getTime() > time05.getTime()) {
		$(".t05").text("さっそくみる");
		$(".t05").attr("href","abema");
	}
	var time05_af = new Date("2021/01/05 20:00");
