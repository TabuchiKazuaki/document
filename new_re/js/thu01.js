$(document).ready(function() {
	...
	if (now.getTime() > change01.getTime()) {
		$('#dd_01').show();
		$(elv01).text('ビデオを視聴する');
		$(elv01).href = "https://abema.tv/video/title/193-56";
	}
	// 無料文言
	...
	// }
		// tn 最新 #2
		var next01_02 = new Date("2018/10/4 22:30");
	...
	if (now.getTime() > change02.getTime()) {
		$('#dd_02').show();
		$(elv02).text('ビデオを視聴する');
		$(elv02).href = "https://abema.tv/video/title/90-1140";
	}
	// 無料文言
	...
	// }
		...
		// 	$(eln02).attr("href","https://abema.tv/channels/abema-special/slots/EQtBHnzaLPmUL7");
		// 	$('#tn_02_s').text('1');
		// }
		// 最新 #3
	...
	if (now.getTime() > change03.getTime()) {
		$('#dd_03').show();
		$(elv03).text('ビデオを視聴する');
		$(elv03).href = "https://abema.tv/video/title/168-7";
	}
	// 無料文言
