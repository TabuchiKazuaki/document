$(document).ready(function() {
	...
	if (now.getTime() > before01.getTime()) {
		$(elv01).text('今すぐ視聴する');
		$(elv01).attr("href","https://abema.tv/channels/abema-special/slots/CnCy1t26VBRPdZ");
	}
	// ビデオ
	...
	// }
		...
		if (now.getTime() > next01_02.getTime()) {
			$(eln01).attr("href","https://abema.tv/channels/abema-special/slots/8uZLw1mcraV1Af");
			$('#tn_01_s').text('2');
		}
		// 最新 #3
	...
	// }
		...
		if (now.getTime() > next02_02.getTime()) {
			$(eln02).attr("href","https://abema.tv/channels/abema-anime/slots/EJ5wnxZ63mLw6F");
			$('#tn_02_s').text('2');
		}
		// 最新 #3
		var next02_03 = new Date("2018/10/14 00:30");
		if (now.getTime() > next02_03.getTime()) {
			$(eln02).attr("href","https://abema.tv/channels/abema-anime/slots/9pGVcFcv8HS85M");
			$('#tn_02_s').text('3');
		}
		// 最新 #4
		var next02_04 = new Date("2018/10/21 00:30");
	...
	if (now.getTime() > before03.getTime()) {
		$(elv03).text('今すぐ視聴する');
		$(elv03).attr("href","https://abema.tv/channels/abema-anime/slots/8uZLxXhUnRYWWb");
	}

	// ビデオ
	var change03 = new Date("2018/10/14 01:30");
	...
	// }
		...
		// tn 最新 #2
		var next03_02 = new Date("2018/10/14 01:30");
		if (now.getTime() > next03_02.getTime()) {
			$(eln03).attr("href","https://abema.tv/channels/abema-anime/slots/8uZLxXhUnRYWWb");
			$('#tn_03_s').text('1');
		}
		// 最新 #3
