$(document).ready(function() {
	...
	if (now.getTime() > change04.getTime()) {
		// $('#dd_04').show();
		$(elv04).text('ビデオを視聴する');
		$(elv04).href = "https://abema.tv/video/title/54-24";
	}
	// 無料文言
	...
	if (now.getTime() > change05.getTime()) {
		// $('#dd_05').show();
		$(elv05).text('ビデオを視聴する');
		$(elv05).href = "https://abema.tv/video/title/54-22";
	}
	// 無料文言
	...
	if (now.getTime() > change06.getTime()) {
		// $('#dd_06').show();
		$(elv06).text('ビデオを視聴する');
		$(elv06).href = "https://abema.tv/video/title/54-21";
	}
	// 無料文言
	...
	if (now.getTime() > change07.getTime()) {
		// $('#dd_07').show();
		$(elv07).text('ビデオを視聴する');
		$(elv07).href = "https://abema.tv/video/title/26-57";
	}
	// // 無料文言
