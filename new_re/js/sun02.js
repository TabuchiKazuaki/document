$(document).ready(function() {
	...
	if (now.getTime() > before04.getTime()) {
		$(elv04).text('今すぐ視聴する');
		$(elv04).attr("href","https://abema.tv/channels/abema-anime/slots/FBsCkLpUDFccP1");
	}
	// ビデオ
	var change04 = new Date("2018/10/07 23:30");
	...
	if (now.getTime() > before05.getTime()) {
		$(elv05).text('今すぐ視聴する');
		$(elv05).attr("href","https://abema.tv/channels/abema-anime/slots/8uxEA9dCLrgSSB");
	}
	// ビデオ
	var change05 = new Date("2018/10/08 00:00");
	...
	// }
		// tn 最新 #2
		var next05_02 = new Date("2018/10/08 00:00");
		if (now.getTime() > next05_02.getTime()) {
			$(eln05).attr("href","https://abema.tv/channels/abema-anime/slots/9pGVYvb4Fpy4BZ");
			$('#tn_05_s').text('2');
		}
		// 最新 #3
	...
	if (now.getTime() > before06.getTime()) {
		$(elv06).text('今すぐ視聴する');
		$(elv06).attr("href","https://abema.tv/channels/abema-anime/slots/EQtBHBqL2Jb9Eo");
	}
	// ビデオ
	var change06 = new Date("2018/10/08 00:45");
	...
	// }
		// tn 最新 #2
		var next06_02 = new Date("2018/10/08 00:45");
		if (now.getTime() > next06_02.getTime()) {
			$(eln06).attr("href","https://abema.tv/channels/abema-anime/slots/ARD2pXjAueWBXu");
			$('#tn_06_s').text('2');
		}
		// 最新 #3
	...
	// ビデオ
	var change07 = new Date("2018/10/10 00:00");
	...
	if (now.getTime() > before08.getTime()) {
		$(elv08).text('今すぐ視聴する');
		$(elv08).attr("href","https://abema.tv/channels/abema-anime/slots/DWTGTP4eJ38B5R");
	}
	// ビデオ
	var change08 = new Date("2018/10/15 00:55");
	...
	// }
		...
		// tn 最新 #2
		var next08_02 = new Date("2018/10/15 00:55");
		if (now.getTime() > next08_02.getTime()) {
			$(eln08).attr("href","https://abema.tv/channels/abema-anime/slots/9k3PmPaySAsXro");
			$('#tn_08_s').text('2');
		}
		// 最新 #3
	...
	if (now.getTime() > before09.getTime()) {
		$(elv09).text('今すぐ視聴する');
		$(elv09).attr("href","https://abema.tv/channels/abema-anime/slots/EEd8uX7p2cpqdq");
	}
	// ビデオ
	var change09 = new Date("2018/10/08 01:00");
	...
	// }
		...
		// tn 最新 #2
		var next09_02 = new Date("2018/10/08 01:00");
		if (now.getTime() > next09_02.getTime()) {
			$(eln09).attr("href","https://abema.tv/channels/abema-anime/slots/9k3PkV8FDCeKa7");
