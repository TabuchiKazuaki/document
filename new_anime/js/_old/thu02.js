$(document).ready(function() {
	...
	if (now.getTime() > before04.getTime()) {
		$(elv04).text('今すぐ視聴する');
		$(elv04).attr("href","https://abema.tv/channels/abema-anime/slots/EEd8w2pbuuFVzw");
	}
	// ビデオ
	var change04 = new Date("2018/10/12 01:15");
	if (now.getTime() > change04.getTime()) {
		$('#dd_04').show();
		$(elv04).text('ビデオを視聴する');
		$(elv04).attr("href","https://abema.tv/video/title/19-30");
	}
	// 無料文言
	...
	// }
		// tn 最新 2
		var next04_02 = new Date("2018/10/12 01:15");
		if (now.getTime() > next04_02.getTime()) {
			$(eln04).attr("href","https://abema.tv/channels/abema-anime/slots/ARD2pq3G1y28Gw");
			$('#tn_04_s').text('2');
		}
		// 最新 #3
		var next04_03 = new Date("2018/10/19 01:15");
		if (now.getTime() > next04_03.getTime()) {
			$(eln04).attr("href","https://abema.tv/channels/abema-anime/slots/ARD2ktTnVni8zb");
			$('#tn_04_s').text('3');
		}
		// 最新 #4
	...
	// 	$('#dd_05').show();
	// 	$(elv05).text('ビデオを視聴する');
	// $(elv05).attr("href","https://abema.tv/channels/abema-anime/slots/ARD2pq3G1y28Gw");
	// }
	// // 無料文言
