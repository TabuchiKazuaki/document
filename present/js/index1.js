...
var cp_t = new Date("2016/09/01 00:00");
...
// 03
var tt03 = new Date("2016/09/01 00:00");
if (now.getTime() > tt03.getTime()){
	$(ch03).show();$(ct03).show();
}
var b003 = new Date("2016/09/30 23:59");
...
// 04
var tt04 = new Date("2016/09/01 00:00");
if (now.getTime() > tt04.getTime()){
	$(ch04).show();$(ct04).show();
}
var b004 = new Date("2016/09/13 23:59");
...
var b005 = new Date("2016/09/30 23:59");
...
var b006 = new Date("2016/09/30 23:59");
...
var b007 = new Date("2016/09/17 23:59");
...
var b008 = new Date("2016/09/30 23:59");
...
var b009 = new Date("2016/09/30 23:59");
