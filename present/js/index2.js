...
// 10
var tt10 = new Date("2018/09/01 00:00");
...
// 11
var tt11 = new Date("2018/09/01 00:00");
if (now.getTime() > tt11.getTime()){
	$(ch11).show();$(ct11).show();
}
var b011 = new Date("2018/09/30 23:59");
...
// 12
var tt12 = new Date("2018/09/01 00:00");
if (now.getTime() > tt12.getTime()){
	$(ch12).show();$(ct12).show();
}
var b012 = new Date("2018/09/30 23:59");
...
// 13
var tt13 = new Date("2018/09/01 00:00");
if (now.getTime() > tt13.getTime()){
	$(ch13).show();$(ct13).show();
	$(bt12).attr("href","javascript:void(0)");
}
var b013 = new Date("2018/09/19 23:59");
...
// 14
var tt14 = new Date("2018/09/01 00:00");
if (now.getTime() > tt14.getTime()){
	$(ch14).show();$(ct14).show();
}
var b014 = new Date("2018/09/19 23:59");
...
// 15
var tt15 = new Date("2018/09/01 00:00");
if (now.getTime() > tt15.getTime()){
	$(ch15).show();$(ct15).show();
}
var b015 = new Date("2018/09/14 23:59");
...
// 16
var tt16 = new Date("2018/09/01 00:00");
if (now.getTime() > tt16.getTime()){
	$(ch16).show();$(ct16).show();
}
var b016 = new Date("2018/09/30 23:59");
...
// 17
var tt17 = new Date("2018/09/01 00:00");
if (now.getTime() > tt17.getTime()){
	$(ch17).show();$(ct17).show();
}
var b017 = new Date("2018/09/30 23:59");
...
// 18
var tt18 = new Date("2018/09/01 00:00");
if (now.getTime() > tt18.getTime()){
	$(ch18).show();$(ct18).show();
}
var b018 = new Date("2018/09/10 23:59");
